...
describe('./fifo-cache.test.ts', () => {
  ...
  test('case-3', () => {
    const cache = new FIFOCache<number>(0);
  ...
  test('case-4', () => {
    const cache = new FIFOCache<number>(1);
